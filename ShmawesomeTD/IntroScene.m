...
-(void)switchBackground{
    ...
    self.background.texture = [SKTexture textureWithImageNamed:[NSString stringWithFormat:@"lultum%lu",self.bgCount]];
...
-(void)didMoveToView:(SKView *)view{
    self.background = [SKSpriteNode spriteNodeWithColor:[SKColor blackColor] size:self.background.size];
